...
function InterviewSpace() {
    ...
    useEffect(() => {
        ...
        vapiref.current.on('message', (message) => {
            if(message.role == "assistant") {
                setTranscription(prev => message.transcript);
    ...
    return(
        <div h-screen w-full flex flex-col justify-center items-center>
            <div className="h-[70vh] w-screen flex flex-row justify-center items-center gap-8 px-8 mt-30 mb-14">
                <div className="flex flex-col flex-1 gap-4 h-full">
                    <div className={`flex-1  flex flex-col items-center justify-center gap-5 bg-[#2d2f43] p-8 rounded-lg shadow-md ${assistantSpeaking ? "ai-speaking" : "" }`}>
                ...
                <div className="h-full flex flex-col flex-2 justify-center items-center overflow-hidden bg-[#161b22] gap-4 rounded-lg shadow-md p-2">
